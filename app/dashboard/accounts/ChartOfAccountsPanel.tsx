...
export default function ChartOfAccountsPanel({ accounts }: Props) {
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-[12px] leading-5 text-[color:var(--text-tertiary)]">
              General Ledger accounts used to classify assets,
              liabilities, equity, revenue, cost of sales and
              expenses. These are separate from your operational
              cash and bank accounts above.
            </p>
          </div>
          ...
          <tbody>
            {filteredAccounts.length > 0 ? (
              ...
              <tr>
                ...
                >
                  No accounting accounts match the current filters.
                </td>
              </tr>
            )}
          </tbody>
